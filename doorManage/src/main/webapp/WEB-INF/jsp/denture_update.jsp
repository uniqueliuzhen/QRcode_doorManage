                                    ...
                                    <form role="form" class="form-horizontal">
                                        <div class="col-md-12">
                                            <div class="form-group" style="margin-top: 10px" >
                                                <h3 style="margin-right: 10px" >使用物料的信息</h3>
                                            </div>
										...
										<div class="form-group" style="margin-top: 10px">
                                            ...
                                            <div class="col-md-2" >
                                                <input class="form-control" type="text" placeholder="使用百分比" id="percentNew" >
                                            </div>
										</div>
										...
										<div class="col-md-11">
                                            <div class="form-group" >
                                                <div class="col-md-3 control-label" style="float:right" >
                                                    <button type="button" class="btn btn-primary" id="save" >确定使用</button>
    ...
    <script>
            ...
            $.ajax({
                ...
                success: function (result){
                    if(null != result && "" != result && 0 == result.status){
                    	$("#no").val(result.data.no).prop("readonly","readonly");
                    	$("#material").val(result.data.material).prop("readonly","readonly");
                    	$("#supplier").val(result.data.supplier).prop("readonly","readonly");
                    	$("#location").val(result.data.location).prop("readonly","readonly");
                    	$("#percentOld").val(result.data.percent).prop("readonly","readonly");
        ...
        $("#save").click(function(){
            if(!$("#save").hasClass("disabled")){
                ...
                if((percentOld - percentNew) < 0 ){
                	alert("已有百分比和使用百分比不符合，请检查");	
                	return;
                }else if((percentOld - percentNew)  > 0 ){
                	if(!images) {
                    	alert("上传使用后图片");
                    	return;
                    }
